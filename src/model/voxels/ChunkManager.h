...
struct CenterChangedEvent {
    std::vector<glm::ivec3> unloadedPositions;
    std::vector<glm::ivec3> loadedPositions;
};
...
public:
    ...
    void SetRenderDistance(int vertical_render_distance, int horizontal_render_distance);
